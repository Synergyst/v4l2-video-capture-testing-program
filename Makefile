...
SOURCES = v4l2-capture-test.cpp crt_filter.cpp vignette_filter.cpp png_loader.cpp
...
CXXFLAGS += -pedantic -Wall -Wformat -O3 -ftree-vectorize -ffast-math -funroll-loops -funsafe-math-optimizations -mcpu=cortex-a72 -mfpu=neon-fp-armv8 -mfloat-abi=hard -DNDEBUG -fstrict-aliasing -flto -DSIMDE_ENABLE_OPENMP -fopenmp -mfpu=neon -flax-vector-conversions -Wextra -fno-omit-frame-pointer -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function
